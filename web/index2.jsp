    ...
    <script type="text/javascript">
        $(function () {
            $("form").submit(function(){
                ...
                $.ajax({
                    url:"${pageContext.request.contextPath}/employee/loginajax",
                    type:"post",
                    dataType:"text",
                    ...
                    success:function (data) {
                        if (data==""){
                           ...
                           window.location.href="${pageContext.request.contextPath}/employee/loginemployee?name="+name+"&password="+password
                        }
                    }
                });
